...
## Development environment and release process
 ...
 - create virtualenv with Flask and status_page installed into it (latter is installed in
...
install it (`pip install status_page.tar.gz`), ensure that configuration file exists and
`STATUS_PAGE_SETTINGS` environment variable points to it, ensure that user has access to the
